...
let NodeApiError: typeof import('n8n-workflow').NodeApiError;
let NodeOperationError: typeof import('n8n-workflow').NodeOperationError;
let moment: typeof import('moment-timezone');
let snakeCase: typeof import('change-case').snakeCase;
let asanaApiRequest: typeof import('./GenericFunctions').asanaApiRequest;
let asanaApiRequestAllItems: typeof import('./GenericFunctions').asanaApiRequestAllItems;
let getColorOptions: typeof import('./GenericFunctions').getColorOptions;
let getTaskFields: typeof import('./GenericFunctions').getTaskFields;
let getWorkspaces: typeof import('./GenericFunctions').getWorkspaces;

(async () => {
  const n8nWorkflow = await import('n8n-workflow');
  NodeApiError = n8nWorkflow.NodeApiError;
  NodeOperationError = n8nWorkflow.NodeOperationError;

  const momentTimezone = await import('moment-timezone');
  moment = momentTimezone.default;

  const changeCase = await import('change-case');
  snakeCase = changeCase.snakeCase;

  const genericFunctions = await import('./GenericFunctions');
  asanaApiRequest = genericFunctions.asanaApiRequest;
  asanaApiRequestAllItems = genericFunctions.asanaApiRequestAllItems;
  getColorOptions = genericFunctions.getColorOptions;
  getTaskFields = genericFunctions.getTaskFields;
  getWorkspaces = genericFunctions.getWorkspaces;
})();
